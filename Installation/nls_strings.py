...
def eliminate_nos_acros(astring):
    ...
    if charindex >= 0:
        ...
        if ((len(right) != 0) and right[0].isalnum()) and \
           ((len(left) != 0) and left[len(left)-1].isalpha()):
    ...
    for nos_string in nos_strings:
        ...
        if charindex >= 0:
            ...
            right2 = astring[charindex+len(nos_string):
                             max(charindex+len(nos_string),
                                 len(astring))]
...
def eliminate_nos_expansion(astring):
    ...
    for expansion in nos_expansion_string:
        ...
        if charindex == 0:
            ...
            return eliminate_nos_expansion(
                lcString[0:charindex] + lcString[charindex + len(expansion):])
